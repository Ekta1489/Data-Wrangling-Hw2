...
##First reading the datasets pols-month.csv, unemployment.csv, snp.csv. Then merging the pols-month.csv, unemployment.csv, and snp.csv into a single dataframe using year and month as keys across datasets.
