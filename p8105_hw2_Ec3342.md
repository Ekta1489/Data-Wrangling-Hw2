...
\#\#Description of the datasets
  ...
  - Dimension of all the datasets - The number of rows in the
    final\_merged\_data is 1573 and the number of columns are 1573. This
    final\_merged\_data is formed by joining the merged\_data which has
    1573 rows and 11 columns and the unemployment\_data which has 816
    rows and 3 columns. The merged\_data was formed by combining
    pols\_data (which has 1644 rows and 10 columns) and snp\_data which
    has 787 and 3columns.
