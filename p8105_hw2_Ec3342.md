...
\#\#First reading the datasets pols-month.csv and clean the data in
...
## merged\_data is formed by joining snp into pols using year and month as keys. final\_merged\_data is formed by joining the merged\_data with unemployment\_data using year and month as keys.
