...
combined\_data would be month, year. The key variables in the
...
\#\#Description of the datasets \*Dimension of datasets- The number of
rows in the final\_merged\_data is 1573 and the number of columns are
1573. This final\_merged\_data is formed by joining the merged\_data
which has 1573 rows and 11columns and the unemployment\_data which has
816 rows and 3columns. The merged\_data was formed by combining
pols\_data (which has 1644 rows and `ncol(pols_data)`columns) and
snp\_data which has 787 and the number of columns are 3. \# Question 3
